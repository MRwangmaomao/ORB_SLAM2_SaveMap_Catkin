...
void Viewer::Run()
{
    ...
    /**********************My add code********************/
    pangolin::Var<bool> saveMap("menu.saveMap",false,true);
    pangolin::Var<bool> saveTrack("menu.saveTrack",false,true);
    ...
    while(1)
    {
        ...
        if(saveMap)
        {
            mpSystem->SaveMap("MapPointandKeyFrame.bin");
//            cout << "Hello world";
        }
        ...
        {
//            cout << "Hello world";
            mpSystem->SaveKeyFrameTrajectoryTUM("KeyFrameTrajectory_903.txt");
        }
